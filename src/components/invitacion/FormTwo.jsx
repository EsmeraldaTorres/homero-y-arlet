...
console.log(acompanist, "acompanist")
  ...
  <div className="d-flex justify-content-center container-1"> 
    ...
    <form action="" onSubmit={handleSubmit} className={`animate__animated p-1 ${send && "animate__zoomOut"}`}>
            <p className="mb-0 display-5 text-center font-paris">Nombre Completo:</p>
            <input 
                type="text" 
                name="name" 
                value={formData.name}
            ...
            />
            <div>
            <p className="mb-0 mt-4 text-center display-5 font-paris">¿Tienes acompañante?</p>
            <div>
    ...
    <div className="checkbox-wrapper-24">
      ...
      {acompanante === "si" && (
        ...
        <div>
          ...
          <p className="lead">Habrá varios solteros en la fiesta, así que será un buen
            momento para conocer gente nueva.</p>
            <p className="mb-0 display-5 font-paris"> ¿Te gustaría aparecer en la lista
            de solteros?</p>
            <div className="d-flex justify-content-center">
      ...
      <label htmlFor="checkbox-no-2" className="mt-2 lead">
        <span></span>No
          ...
          {soltero === "no" && (<>
            ...
            <p className="lead mb-0 mt-2">
              Entendemos, no hay problema. 
                        ...
                        <p className="lead">
                      ¡Lo importante es que disfrutes del
                        día con nosotros!
                      </p>
    </motion.div>  </>    )}
          ...
          {soltero === "si" && (
                         ...
                         >
            <div>
              <p className="lead mt-3 mb-3">¡Excelente!
               </p>
           
               <p className="mb-0 display-5 font-paris ">   Por favor, apóyanos con tu Instagram</p>
              ...
              className="w-100 p-2 mb-3"
                ...
                required={soltero === "si"}
              />
                               <p className="lead"> ¡Y compartenos el enlace de tu mejor foto!</p>
                               <p className="mb-1 text-blue">1. En las fotos que has publicado de tu instagram, abre la que consideres tu mejor foto.</p>
                               <p className="mb-1 text-blue">2. Toca el icono parecido a este <i className="bi bi-cursor display-5"></i>, que está justo debajo y en los iconos de la izquierda.</p>
                               <p className="mb-3 text-blue">3. Toca el icono de copiar enlace <i class="bi bi-link-45deg display-5"></i> y pegalo en el siguiente espacio</p>
              ...
              className="w-100 p-2"
                ...
                onChange={(e) => setFormData({...formData, fotoInstagram: e.target.value})}
...
<div className="w-100 mt-2 mb-0 d-flex flex-column align-items-center">
            ...
            <p className="mb-0 display-5 text-center font-paris">Escribe aquí tus buenos deseos para nosotros: </p>       
                        <textarea 
                        type="text" 
                        name="message" 
    ...
    <div className="checkbox-wrapper-24 lead text-center d-flex justify-content-center">
      ...
      <label htmlFor="checkbox-si-5" className="m-2 ">
        <span></span>No
            ...
            <div className="mt-4">
            <p className="mb-0 display-5 font-paris text-center">Tu número de teléfono al cual te enviamos esta invitación:
            </p>
            <input
                 type="number"  
                 name="phone" 
...

{
  formData.acompanist != "" ? 
  <>
  <p className="lead">{formData.name} & {formData.acompanist} han quedado registrados como invitados a nuestra boda.</p>
  </> : 
