    ...
    <>
      <section className="fecha-foto p-4 d-flex flex-column justify-content-around  pt-4">
        ...
        <div
          ...
          <div id="xv"  data-aos="fade-up" data-aos-duration="2000" className="animate__animated bg-cuenta-regresiva">
            <p
              id="demo"
          ...
          data-aos-duration="1000"
        className="mb-0 display-6 text-center">SAVE THE DATE</p>
        </div>
      ...
      <section className="main-phrase d-flex justify-content-center">
        <div className="w-75">
          ...
          >
          <p className="principal-text" data-aos="fade-up" data-aos-duration="3000">
